...
from .sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, SICKRelatednessEval, STSBenchmarkFinetune, KorSTS, KLUESTS
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        self.list_tasks = ['CR', 'MR', 'MPQA', 'SUBJ', 'SST2', 'SST5', 'TREC', 'MRPC',
                           ...
                           'STSBenchmark-finetune', 'STSBenchmark-fix', "korsts", "kluests"]
    def eval(self, name):
        ...
        elif name.lower() == "korsts":
            self.evaluation = KorSTS()
        elif name.lower() == "kluests":
            self.evaluation = KLUESTS()
